...
export const CARD_DETAILS_REQUEST = 'CARD_DETAIL_REQUEST';
export const CARD_DETAILS_SUCCESS = 'CARD_DETAIL_SUCCESS';
export const CARD_DETAILS_FAIL = 'CARD_DETAIL_FAIL';
